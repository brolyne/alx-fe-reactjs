...
export default function AddRecipeForm() {
  ...
  // Get steps from instructions
  const steps = formData.instructions.split('\n').filter((step) => step.trim());
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (errors.cookTime) setErrors({ ...errors, cookTime: '' });
                  }}
            ...
            <div>
              <label htmlFor="instructions" className="block text-sm font-semibold text-gray-700 mb-2">
                Cooking Instructions (one per line) * ({steps.length} {steps.length === 1 ? 'step' : 'steps'})
              </label>
              <textarea
                id="instructions"
                name="instructions"
